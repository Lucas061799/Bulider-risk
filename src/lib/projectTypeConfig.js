...
export const PROJECT_TYPE_CONFIG = {
  [PROJECT_TYPES.GROUND_UP]: {
    ...
    steps: [
      ...
      { id: 5, label: 'Property Protection',  key: SECTIONS.PROPERTY_PROTECTION },
      { id: 6, label: 'Eligibility',          key: SECTIONS.ELIGIBILITY },
      { id: 7, label: 'Loss History',         key: SECTIONS.LOSS_HISTORY },
      { id: 8, label: 'Financial',            key: SECTIONS.FINANCIAL },
      { id: 9, label: 'Existing Coverage',    key: SECTIONS.EXISTING_COVERAGE },
      { id: 10, label: 'Additional Interests', key: SECTIONS.ADDITIONAL_INTERESTS },
      { id: 11, label: 'Bind Confirmation',   key: SECTIONS.BIND_CONFIRMATION },
    ],
    bindAttestation: {
